...
const TE_DATA = {
    'john-3': [{ v: 1, t: 'అప్పుడు ఫరిసీయులలో నికొదేము అనువాడొకడుండెను; అతడు యూదుల అధికారి.' }, { v: 2, t: 'అతడు రాత్రివేళ యేసు దగ్గరకు వచ్చి — రబ్బీ, నీవు దేవుని యొద్ద నుండి వచ్చిన బోధకుడవని మేమెరుగుదుము.' }, { v: 3, t: 'యేసు అతనికి ఇట్లు చెప్పెను — నేను నిన్ను నిజముగా నిజముగా చెప్పుచున్నాను, తిరిగి జన్మింపకపోతే ఏ మనుష్యుడైనను దేవుని రాజ్యమును చూడలేడు.' }, { v: 16, t: 'దేవుడు లోకమును ఎంతగా ప్రేమించెనంటే, తన అద్వితీయకుమారునిగా ఉన్నవానిని అనుగ్రహించెను; ఆయనయందు విశ్వాసముంచు ప్రతివాడును నశింపక నిత్యజీవము పొందునట్లు అనుగ్రహించెను.' }, { v: 17, t: 'ఎందుకనగా దేవుడు తన కుమారుని లోకమును తీర్పు తీర్చుటకు లోకలోనికి పంపలేదు గాని దానివలన లోకము రక్షింపబడుటకు పంపెను.' }],
    'psalms-23': [{ v: 1, t: 'యెహోవా నా కాపరి; నాకు కొదువ కలుగదు.' }, { v: 2, t: 'ఆయన నన్ను పచ్చిక బయళ్ళలో పరుండబెట్టును; విశ్రాంతికరమైన జలాల దగ్గరకు నన్ను నడిపించును.' }, { v: 3, t: 'ఆయన నా ప్రాణమును తేల్చును; తన నామమునుబట్టి నీతిమార్గములలో నన్ను నడిపించును.' }, { v: 4, t: 'మృత్యుచ్ఛాయా లోయలో నేను నడచినను అపాయమేదియు భయపడను; నీవు నాతోఉన్నావు; నీ దండమును నీ కఱ్ఱయు నన్ను ఆదరించుచున్నవి.' }, { v: 5, t: 'నా శత్రువుల యెదుట నీవు నాకు బల్లపరచుచున్నావు; నా తలకు నూనె పూయుచున్నావు; నా పాత్ర నిండి పొర్లుచున్నది.' }, { v: 6, t: 'నా జీవితకాలమంతటను మేలును కృపయు నన్ను అనుసరించును; నేను యెహోవా మందిరములో చిరకాలము నివసింతును.' }],
    'romans-8': [{ v: 1, t: 'కాగా క్రీస్తుయేసునందున్నవారికి ఇప్పుడు శిక్షావిధి లేదు.' }, { v: 2, t: 'ఎందుకనగా క్రీస్తుయేసునందున్న జీవాత్మ అను నియమము పాపమరణముల నియమము నుండి నన్ను విడిపించెను.' }, { v: 28, t: 'దేవుని ప్రేమించువారికి, అనగా తన సంకల్పమునుబట్టి పిలువబడినవారికి, సమస్తమును మేలుకొఱకే జరుగునని మనకు తెలియును.' }],
    'philippians-4': [{ v: 4, t: 'ప్రభువునందు సదా సంతోషించుడి; మరల చెప్తాను సంతోషించుడి.' }, { v: 6, t: 'దేనిగురించియు చింతపడకుడి గాని ప్రతి విషయమందు కృతజ్ఞతాస్తుతులతో కూడిన మీ విజ్ఞాపనలు దేవునికి తెలియజేయుడి.' }, { v: 13, t: 'నన్ను బలపరచువాని ద్వారా సమస్తమును చేయగలను.' }],
    'genesis-1': [{ v: 1, t: 'ఆదియందు దేవుడు భూమ్యాకాశములను సృష్టించెను.' }, { v: 2, t: 'భూమి నిరాకారముగను శూన్యముగను ఉండెను; అగాధజలముల మీద అంధకారము కమ్మియుండెను; మరియు దేవుని ఆత్మ జలముల మీద అల్లాడుచుండెను.' }, { v: 3, t: 'అప్పుడు దేవుడు వెలుగు కమ్మని చెప్పెను; వెలుగు కలిగెను.' }],
};

const teluguVersesFor = (bookId, ch) => {
    const key = `${bookId}-${ch}`;
    return TE_DATA[key] || [{ v: 1, t: 'ఈ అధ్యాయానికి తెలుగు అనువాదం త్వరలో వస్తుంది. (Coming soon)' }];
};
    ...
    const loadChapter = useCallback(async (b, ch, language, highlightIdx = null) => {
        ...
        try {
            ...
            if (language === 'te') {
                ...
                result = teluguVersesFor(b.id, ch);
            } else {
