                ...
                <div className="container" style={{ position: 'relative', zIndex: 1001 }}>
                    ...
                    <div style={{
                        ...
                        <NavLink to="/" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
                            <img src="/logo.png" alt="EFM" style={{ height: isScrolled ? '34px' : '40px', objectFit: 'contain', transition: 'height 0.3s ease' }} />
                        ...
                        <nav className="desktop-nav">
                            <ul style={{ display: 'flex', gap: '1.8rem', listStyle: 'none', margin: 0, padding: 0 }}>
                                {navLinks.map((link) => (
                                    <li key={link.name}>
                                        <NavLink to={link.path} className={({ isActive }) => isActive ? 'nav-link nav-link-active' : 'nav-link'}>
                                            {link.name}
                                        </NavLink>
                                    </li>
                                ))}
                        ...
                        <div className="desktop-cta" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            <button onClick={toggleTheme} style={{ background: 'transparent', border: 'none', color: 'var(--color-text-primary)', cursor: 'pointer', padding: '6px', borderRadius: '8px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ flex: 1 }}>
                            <Link to="/" onClick={() => setIsMobileMenuOpen(false)}>
                                <img src="/logo.png" alt="EFM" style={{ height: '26px', objectFit: 'contain' }} />
                            </Link>
                        </div>
            ...
            >
                ...
                <div style={{
                    ...
                    <Link to="/" onClick={() => setIsMobileMenuOpen(false)} style={{ display: 'flex', alignItems: 'center' }}>
                        <img src="/logo.png" alt="EFM" style={{ height: '32px', objectFit: 'contain' }} />
                    </Link>
                    <button
